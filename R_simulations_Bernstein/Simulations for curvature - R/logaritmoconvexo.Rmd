...
write.matrix(betaT,file="betaT_log.csv", sep=",")
write.matrix(betaT2,file="betaT2_log.csv", sep=",")
...
for (i in 1:n_sims) {
  ...
  cv<-cv.SOFR.con(Ngrid,y,X,T,constr = "concave")
  indmin<-which.min(cv)
  ###############################################
...
for (i in 1:n_sims) {
  ...
  write.matrix(X,file=paste("X_log001_", i,"_", N, ".csv", sep=""), sep= ",")
  ...
  write.matrix(y,file=paste("y_log001_", i,"_", N, ".csv", sep=""), sep= ",")
  ...
  out<-SOFR.con(N1,y,X,T,m,constr = "concave")
  # out.NULL<-SOFR.NULL(N1,y,X,T,m,constr = NULL)
  beta1t<-out$betaSOFR #constrained estimate
...
for (i in 1:n_sims) {
  ...
  write.matrix(X,file=paste("X_log005_", i,"_", N, ".csv", sep=""), sep= ",")
  ...
  write.matrix(y,file=paste("y_log005_", i,"_", N, ".csv", sep=""), sep= ",")
